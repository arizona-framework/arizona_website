...
render(Bindings) ->
    ...
    <div id="{arizona_template:get_binding(id, Bindings)}" class="min-h-screen bg-gradient-to-br from-obsidian via-charcoal to-arizona-terracotta">
            ...
            <div class="container mx-auto text-center">
                ...
                <div class="bg-gradient-to-r from-arizona-gold/20 to-arizona-terracotta/20 border border-arizona-gold/50 rounded-xl p-6 mb-12 max-w-2xl mx-auto backdrop-blur-sm">
                    <div class="flex items-center justify-center space-x-3 mb-3">
                        <svg class="h-6 w-6 text-arizona-gold" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    <p class="text-silver text-sm">
                        ...
                        <br>Follow our progress and contribute at <a href="https://github.com/arizona-framework/arizona" class="text-arizona-teal underline hover:text-arizona-sage">GitHub</a>.
                    </p>
                </div>
        ...
        <section id="examples" class="py-20 px-6">
            <div class="container mx-auto">
                ...
                <div class="max-w-4xl mx-auto">
                    <div class="bg-obsidian/80 backdrop-blur-sm rounded-xl border border-slate overflow-hidden shadow-2xl">
                        <div class="bg-charcoal px-6 py-4 border-b border-slate">
                            <h3 class="text-pearl font-semibold">counter_view.erl</h3>
                        </div>
                        <div class="p-6">
                            <pre class="text-sm text-arizona-teal overflow-x-auto"><code>
                            -module(counter_view).
                            -behaviour(arizona_stateful).
                            -compile(\{parse_transform, arizona_parse_transform}).
            ...
            <div class="container mx-auto text-center">
                ...
                <div class="mt-8 pt-8 border-t border-slate">
                    <p class="text-arizona-sand text-sm">
                        © 2025 Arizona Framework. Built with Arizona 🌵
                    </p>
                </div>
            </div>
        </footer>
